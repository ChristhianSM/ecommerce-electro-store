...
export const Confirmation = ({shoppingCart,total}) => {
    ...
    return (
        <div className="flex my-10 gap-2 justify-center">
            <div className = "w-7/12  px-5 py-10 bg-gray-100">
                ...
                <div className = "grid grid-cols-2 mt-5">
                    <div className = "mb-2">
                        ...
                        <div className = "mb-3">
                            <p className = "font-semibold text-purple-500">Tienda ElectroStore</p>
                            <p>Urbanizacion San jose Jiron H - 260 Piura</p>
                        </div>
                        <div className = "mb-3">
            ...
            <div className = "w-5/12 px-5 py-10">
